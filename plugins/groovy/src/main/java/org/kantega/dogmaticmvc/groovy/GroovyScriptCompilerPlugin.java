 ...
 *
 */
public class GroovyScriptCompilerPlugin extends DogmaticPluginBase {

    private List<ScriptCompiler> compilers;

    public GroovyScriptCompilerPlugin(ServletContext servletContext) {
        this.compilers = Collections.<ScriptCompiler>singletonList(new GroovyScriptCompiler(servletContext));
    }
