 ...
 *
 */
public class ThisMethodSucksPlugin extends DogmaticPluginBase {

    private final List<VerificationPhase> phases;

    public ThisMethodSucksPlugin(TemplateEngine templateEngine) {
        phases = Collections.<VerificationPhase>singletonList(new CyclomaticComplexity(templateEngine));
    }
